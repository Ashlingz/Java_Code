...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        header.setBackground(new java.awt.Color(204, 153, 255));
        ...
        MY.setBackground(new java.awt.Color(153, 204, 255));
        ...
        cmdMonth.setForeground(new java.awt.Color(51, 51, 51));
        cmdMonth.setText("January");
        cmdMonth.setFocusPainted(false);
        cmdMonth.setFont(new java.awt.Font("Kh Content", 1, 18)); // NOI18N
        ...
        cmdYear.setForeground(new java.awt.Color(51, 51, 51));
        cmdYear.setText("2018");
        cmdYear.setFocusPainted(false);
        cmdYear.setFont(new java.awt.Font("Kh Content", 1, 18)); // NOI18N
        ...
        slide.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
